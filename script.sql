...
`id_modalidade_cli` int null, `txt_modalidade_cli` varchar(100) NULL, `flg_fisicuturista_cli` tinyint(1) DEFAULT FALSE, 
`flg_musculacao_cli` tinyint(1) DEFAULT FALSE, `flg_marcial_cli` tinyint(1) DEFAULT FALSE, 
